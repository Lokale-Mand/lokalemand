...
class SellerChatDetailOrderItemWidget extends StatefulWidget {
  ...
  const SellerChatDetailOrderItemWidget(
      {super.key, required this.orderData, required this.customerName});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(
          context,
          orderDetailScreen,
          arguments: widget.orderData?.orderId?.toString(),
        );
      },
      child: Column(
        children: [
          ...
          Container(
            ...
            child: CustomTextLabel(
              text:
                  "${widget.customerName}'s ${getTranslatedValue(context, "payment_method_")}",
              style: TextStyle(
                color: ColorsRes.mainTextColor,
                fontWeight: FontWeight.w600,
              ),
