  ...
  getAppSettingsProvider(BuildContext context) async {
    ...
    try {
      ...
      if (settingsData[ApiAndParams.status].toString() == "1") {
        ...
        Constant.session.setBoolData(SessionManager.keyPopupOfferEnabled,
            settings.popupEnabled == "1", false);
        Constant.session.setBoolData(SessionManager.keyPopupAlwaysShowHome,
            settings.popupAlwaysShowHome == "1", false);
        Constant.session.setData(SessionManager.keyPopupOfferType,
            settings.popupType.toString(), false);
        Constant.session.setData(SessionManager.keyPopupOfferTypeId,
            settings.popupTypeId.toString(), false);
        Constant.session.setData(SessionManager.keyPopupOfferImage,
            settings.popupImage.toString(), false);
        Constant.session.setData(SessionManager.keyPopupOfferUrl,
            settings.popupUrl.toString(), false);
