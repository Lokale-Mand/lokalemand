...
class SellerProductVariantDropDownMenuGrid extends StatefulWidget {
  final List<SellerVariants>? variants;
  final String from;
  final SellerProductListItem product;
  final bool isGrid;

  const SellerProductVariantDropDownMenuGrid({
    Key? key,
    this.variants,
    required this.from,
  ...
  @override
  State<SellerProductVariantDropDownMenuGrid> createState() =>
      _ProductVariantDropDownMenuGridState();
}

class _ProductVariantDropDownMenuGridState
    extends State<SellerProductVariantDropDownMenuGrid> {
  @override
                                                        ...
                                                        text: double.parse(widget
                                                            ...
                                                            ? GeneralMethods.getCurrencyFormat(
                                                                double.parse(widget
                                                                    ...
                                                                    .toString()))
                                                            : GeneralMethods.getCurrencyFormat(
                                                                double.parse(widget.variants![index].price.toString())),
                                                        softWrap: true,
