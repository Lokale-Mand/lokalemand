                              ...
                              onPressed: () async{
                                try {
                                  if (int.parse(edtProductStock.text.toString()) >
                                    ...
                                    params[ApiAndParams.productId] = widget.productData.id;
                                    ...
                                    await cartListProvider
                                      ...
                                      await cartListProvider
                                        ...
                                        params: params,
                                        isUnlimitedStock:
                                        widget.productData.isUnlimitedStock == "1",
                                        ...
                                        actionFor: "add",
                                          ...
                                          if (value == true) {
                                            Map<String, String> params = {
                                              ApiAndParams.latitude: context.read<CheckoutProvider>().selectedAddress?.latitude?.toString() ??
                                                  Constant.session.getData(SessionManager.keyLatitude),
                                              ApiAndParams.longitude:
                                              context.read<CheckoutProvider>().selectedAddress?.longitude?.toString() ??
                                                  Constant.session.getData(SessionManager.keyLongitude),
                                              ApiAndParams.isCheckout: "1"
                                            };
                                            context.read<CheckoutProvider>().getOrderChargesProvider(context: context, params: params);
                                    ...
                                    await cartListProvider
                                      ...
                                      actionFor: "add",
                                        ...
                                        if (value == true) {
                                          ...
                                          edtProductStock.text = (int.parse(edtProductStock
                                              .text
                                              .toString()
                                              .isEmpty
                                              ? "0"
