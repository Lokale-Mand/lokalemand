        ...
        return Consumer<AppSettingsProvider>(
          builder: (context, appSettingsProvider, child) {
            if (languageProvider.languageState == LanguageState.error ||
              ...
              print(">>>>>>>>>> ${languageProvider.message} && ${appSettingsProvider.message}");
              return Scaffold(
                ...
                body: NoInternetConnectionScreen(
                  height: MediaQuery
                      ...
                      .size
                      .height,
                  message: languageProvider.message.isNotEmpty ? languageProvider.message : appSettingsProvider.message,
                  callback: () async {
                    await callAllApis();
                  },
                ),
