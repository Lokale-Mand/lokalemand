    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          (context.read<CheckoutProvider>().checkoutAddressState == CheckoutAddressState.addressLoaded && context.read<CheckoutProvider>().selectedAddress?.id != null)
              ? Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          ...
                          softWrap: true,
                          style: TextStyle(color: ColorsRes.mainTextColor,fontWeight: FontWeight.w500),
                        ),
                        GestureDetector(
                          onTap: () {
