              ...
              child: SingleChildScrollView(
                ...
                child: Consumer<HomeScreenProvider>(
                  builder: (context, homeScreenProvider, _) {
                    Map<String, List<String>> map = homeScreenProvider.homeOfferImagesMap;
        ...
        return section.products.isNotEmpty
            ? Column(
                children: [
                  ...
                  if (context.read<HomeScreenProvider>().homeOfferImagesMap.containsKey("below_section-${section.id}"))
                    getOfferImages(
                        context.read<HomeScreenProvider>().homeOfferImagesMap["below_section-${section.id}"]?.toList()),
                ],
              )
            : Container();
      }),
